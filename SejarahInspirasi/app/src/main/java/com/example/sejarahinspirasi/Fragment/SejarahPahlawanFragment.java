...
public class SejarahPahlawanFragment extends Fragment {
    ...
    public SejarahPahlawanFragment(Context context, int categoryId){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sejarah_pahlawan, container, false);
    }
