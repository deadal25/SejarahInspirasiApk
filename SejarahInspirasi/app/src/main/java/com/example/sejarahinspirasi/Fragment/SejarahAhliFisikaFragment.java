...
import com.example.sejarahinspirasi.Model.Sejarah;
import com.example.sejarahinspirasi.R;
import java.util.ArrayList;

public class SejarahAhliFisikaFragment extends Fragment {
    ...
    public SejarahAhliFisikaFragment(Context context, int categoryId){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sejarah_ahli_fisika, container, false);
    }
